...
const Sidebar = () => {
  ...
  return (
    <div className='bg-primary h-screen rounded pt-[38px]'>
      ...
      <div className='mt-[78px] relative after:absolute after:content-[""] after:w-full after:h-full after:top-0 after:left-[25px] after:bg-white py-[20px] after:z-[-1] z-[1] overflow-hidden after:rounded-l-[20px] before:absolute before:content-[""] before:w-[8px] before:h-full before:top-0 before:right-0 before:bg-primary before:rounded-l-[20px]'>
      ...
      </div>
      {
        ...
        <div className='h-screen w-full bg-orange-500 absolute top-0 left-0 z-[1] flex justify-center items-center'>
          <div className='bg-white w-[1000px] py-[50px] px-[50px] rounded-[10px]'>
